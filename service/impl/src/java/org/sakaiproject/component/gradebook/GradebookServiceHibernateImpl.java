	...
	public void transferGradebookDefinitionXml(String fromGradebookUid, String toGradebookUid, String fromGradebookXml) {
		...
		if(category.size() !=0) {
			...
			while(itUpdate.hasNext()){
				...
				createCategory(gradebook.getId(), catObj.getName(), catObj.getWeight(), 0, catObj.getDropLowest(), catObj.getDropHighest(), catObj.getKeepHighest(), catObj.getPointValue(), catObj.getRelativeWeight(), catObj.getIsExtraCredit());				
			}
		}
