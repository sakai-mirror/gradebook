            ...
            <t:dataTable id="table1"
               ...
               <%--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                <t:columns value="#{spreadsheetUploadBean.assignmentList}" var="colIndex" >
                    <f:facet name="header">
                        <h:panelGrid>
                            <t:radio for=":form:assignment" index="#{colIndex}" rendered="#{spreadsheetUploadBean.assignmentHeaders[colIndex]!= 'Student Name'}"/>
                            <t:outputText value="#{spreadsheetUploadBean.assignmentHeaders[colIndex]}" rendered="#{spreadsheetUploadBean.assignmentHeaders[colIndex] == 'Student Name'}"/>
                        </h:panelGrid>
