	  ...
	  <h:form id="gbForm">
		...
		<h:panelGrid cellpadding="0" cellspacing="0"
			...
			<h:panelGroup>
				...
				<h:outputText id="cumScore" value="#{studentViewBean.courseGrade}" rendered="#{studentViewBean.courseGradeReleased && !studentViewBean.nonCalculatedCourseGradeOverride}">
